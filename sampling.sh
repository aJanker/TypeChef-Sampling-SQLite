...
# single conf
    extraFlagsSC="--singleconf --rootfolder /scratch/janker/sqlite"
...
#    mv ${outBase}.errreport ${outBase}_singleconf.errreport	
 ...
 # pairwise
    extraFlagsPW="--pairwise --rootfolder /scratch/janker/sqlite"
...
#    mv ${outBase}.errreport ${outBase}_pairwise.errreport 
 ...
 # code coverage nh
    extraFlagsCC="--rootfolder /scratch/janker/sqlite --codecoveragenh"
